...
def upgrade():
    op.create_table(table_name='users', columns=[sa.Column('id', sa.Integer(), nullable=False, primary_key=True), sa.Column('email', sa.String(), nullable=False, unique=True), sa.Column(
